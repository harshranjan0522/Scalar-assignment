...
export default function Board({ search, filter, onFilterOptionsChange }) {
    ...
    const sourceList = newData.find((l) => String(l.id) === source.droppableId);
        ...
        <Droppable droppableId="board" direction="horizontal" type="list">
            ...
            <div className="board" ref={provided.innerRef}{...provided.droppableProps}>
                ...
                if (filter === "nearest") {
                    ...
                    ? new Date(b.due_date): new Date(8640000000000000);
                    return dateA - dateB;
                });
                }
                if (filter === "farthest") {
                ...
                return (
                    ...
                    onCardUpdated={(updatedCard) => {
                        setData((prev) =>
                        prev.map((l) => ({...l,cards: l.cards.map((c) =>
                    ...
                    onRenameList={(listId, newTitle) => {setData((prev) =>
